...
public class AddProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String p2 = request.getParameter("productDesc");
            String p3 = request.getParameter("price");
            String i1 = request.getParameter("imageUrl");
            int price1 = Integer.parseInt(p3);
            String sq1 = "insert into products(name,description,price,image_url)values('" + p1 + "','" + p2 + "','" + price1 + "','" + i1 + "')";
            ...
            out.println("<h2 class='card-title mt-3'>Product Added Successfully</h2>");
            out.println("<div class='text-start mt-4'>");
            out.println("<p><strong><i class='bi bi-box-seam'></i> Name:</strong> " + p1 + "</p>");
            out.println("<p><strong><i class='bi bi-card-text'></i> Description:</strong> " + p2 + "</p>");
            out.println("<p><strong><i class='bi bi-currency-rupee'></i> Price:</strong> ₹" + price1 + "</p>");
            out.println("<p><strong><i class='bi bi-image'></i> Image URL:</strong> <a href='" + i1 + "' target='_blank' class='btn btn-link p-0'>View Image</a></p>");
            out.println("</div>");
